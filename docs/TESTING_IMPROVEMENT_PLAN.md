...
**继续 Phase 3: 组件测试 (6/9 待完成)**:
1. TripMapToolbar 组件测试 (天数切换、路线控制、视图折叠)
2. 卡片组件测试 (AttractionCard, HotelCard)
3. 复杂地图组件测试 (TripOverviewMap, MapView)
4. 设置页面组件测试 (ApiKeyManager)
