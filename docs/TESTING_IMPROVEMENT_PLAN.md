...
**Phase 4: API 路由测试 (0/6 待完成)**:
1. 核心 API 测试 (generate-itinerary, trips, expenses)
2. 用户相关 API 测试 (profile, password, api-keys)

**预计时间**: 6-8 小时

**或者 Phase 7 并行**: 测试基础设施（Mock 配置、CI/CD、测试文档）
